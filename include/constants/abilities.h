...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_SPICY_SPRAY = 313,
    ABILITIES_COUNT_GEN9,
    ABILITIES_NEW = ABILITIES_COUNT_GEN9,

    ABILITY_PLANE_SHIFT = (ABILITIES_NEW +0), 
    ABILITY_ITEM_GET = (ABILITIES_NEW +1), 
    ABILITY_GRAND_DEBUT = (ABILITIES_NEW +2),
    ABILITY_OPPOSITE_DAY = (ABILITIES_NEW +3), //
    ABILITY_CONSTRICTOR = (ABILITIES_NEW +4),
    ABILITY_WHITEOUT = (ABILITIES_NEW +5),
    ABILITY_PARROT = (ABILITIES_NEW +6),
    ABILITY_FOCUS_BOOST = (ABILITIES_NEW +7),
    ABILITY_MOVE_RELEARNER = (ABILITIES_NEW +8), //
    ABILITY_DOUBLE_WALLOP = (ABILITIES_NEW +9), //
    ABILITY_WONDERLAND = (ABILITIES_NEW +10), //
    ABILITY_TRICKLAND = (ABILITIES_NEW +11), //


    ABILITIES_COUNT = (ABILITIES_NEW +12),
};
