...
/// NEEDS MORE FOR CROSS GEN EVOS ETC
...
enum HoennDexOrder
{
    ...
    HOENN_DEX_ROSELIA,
    HOENN_DEX_ROSERADE,
    HOENN_DEX_SCATTERBUG,//103
    HOENN_DEX_SPEWPA,
    HOENN_DEX_VIVILLON,
    HOENN_DEX_SHINX,
    HOENN_DEX_LUXIO,
    HOENN_DEX_LUXRAY,
    HOENN_DEX_FLABEBE,//102
    HOENN_DEX_FLOETTE,
    HOENN_DEX_FLORGES,
    HOENN_DEX_SKIDDO,
    HOENN_DEX_GOGOAT,
    ...
    HOENN_DEX_PETILIL,
    HOENN_DEX_LILLIGANT,
    HOENN_DEX_PACHIRISU,//104
    HOENN_DEX_DUCKLETT,
    HOENN_DEX_SWANNA,
    HOENN_DEX_BURMY,//WOODS
    HOENN_DEX_WORMADAM,
    HOENN_DEX_MOTHIM,
    HOENN_DEX_COMBEE,
    HOENN_DEX_VESPIQUEN,
    ...
    HOENN_DEX_ESPURR,
    HOENN_DEX_MEOWSTIC,
    HOENN_DEX_NOIBAT,//RUSTURF
    HOENN_DEX_NOIVERN,
    HOENN_DEX_CARBINK,
    HOENN_DEX_DIANCIE = HOENN_DEX_CARBINK,
    HOENN_DEX_SHAYMIN,
    HOENN_DEX_PHANTUMP,//spooky
    HOENN_DEX_TREVENANT,
    HOENN_DEX_HONEDGE,
    HOENN_DEX_DOUBLADE,
    HOENN_DEX_AEGISLASH,
    ...
    HOENN_DEX_GABITE,
    HOENN_DEX_GARCHOMP,
    HOENN_DEX_SHELLOS,//106
    HOENN_DEX_GASTRODON,
    HOENN_DEX_SANDYGAST,
    HOENN_DEX_PALOSSAND,
    HOENN_DEX_CRABRAWLER,
    HOENN_DEX_CRABOMINABLE,
    HOENN_DEX_GLAMEOW,//110
    HOENN_DEX_PURUGLY,
    HOENN_DEX_GRUBBIN,
    HOENN_DEX_CHARJABUG,
    HOENN_DEX_VIKAVOLT,
    ...
    HOENN_DEX_MELTAN,//game corner exclusive
    HOENN_DEX_MELMETAL,
    HOENN_DEX_KARRABLAST,//117. is this gauntlet island exclusive?
    ...
    HOENN_DEX_HEATMOR,//FIERY PATH
    HOENN_DEX_TURTONATOR,
    HOENN_DEX_SALANDIT,
    HOENN_DEX_SALAZZLE,
    HOENN_DEX_SCRAGGY,//113
    HOENN_DEX_SCRAFTY,
    HOENN_DEX_ZORUA,
    HOENN_DEX_ZOROARK,
    HOENN_DEX_SHELMET,
    ...
    HOENN_DEX_DIGGERSBY,
    HOENN_DEX_DURANT,
    HOENN_DEX_MORELULL,//114
    HOENN_DEX_SHIINOTIC,
    HOENN_DEX_PANCHAM,
    HOENN_DEX_PANGORO,
    HOENN_DEX_DRAMPA,
    HOENN_DEX_GOLETT,//METEOR FALLS
    HOENN_DEX_GOLURK,
    HOENN_DEX_MINIOR,
    HOENN_DEX_DRUDDIGON,
    HOENN_DEX_MIENFOO,//JAGGED ASS
    HOENN_DEX_MIENSHAO,
    HOENN_DEX_LARVESTA,//LAVARIDGE
    HOENN_DEX_VOLCARONA,
    HOENN_DEX_HELIOPTILE,//DESERT
    HOENN_DEX_HELIOLISK,
    ...
    HOENN_DEX_SIGILYPH,
    HOENN_DEX_MARACTUS,
    HOENN_DEX_TYRUNT,//FOSSIL
    HOENN_DEX_TYRANTRUM,
    HOENN_DEX_AMAURA,
    HOENN_DEX_AURORUS,
    HOENN_DEX_DHELMISE,//abandoned ship
    HOENN_DEX_ALOMOMOLA,//GOOD ROD
    ...
    HOENN_DEX_ROTOM,
    HOENN_DEX_ELGYEM,//gauntlet island exclusive like karrablast technically
    HOENN_DEX_BEHEEYEM,
    HOENN_DEX_BERGMITE,
    HOENN_DEX_AVALUGG,
    HOENN_DEX_SPRITZEE,//115
    HOENN_DEX_AROMATISSE,
    HOENN_DEX_THROH,
    HOENN_DEX_SAWK,
    HOENN_DEX_VENIPEDE,//118
    ...
    HOENN_DEX_KOMALA,
    HOENN_DEX_CARNIVINE,
    HOENN_DEX_CROAGUNK,//120
    HOENN_DEX_TOXICROAK,
    HOENN_DEX_GOOMY,
    HOENN_DEX_SLIGGOO,
    HOENN_DEX_GOODRA,
    HOENN_DEX_EMOLGA,
    HOENN_DEX_DRIFLOON,//121
    HOENN_DEX_DRIFBLIM,
    HOENN_DEX_LITWICK,
    HOENN_DEX_LAMPENT,
    ...
    HOENN_DEX_DEDENNE,
    HOENN_DEX_HAWLUCHA,
    HOENN_DEX_PUMPKABOO,//MTPYRE
    HOENN_DEX_GOURGEIST,
    HOENN_DEX_SPIRITOMB,
    HOENN_DEX_GOTHITA,
    HOENN_DEX_GOTHORITA,
    HOENN_DEX_GOTHITELLE,
    HOENN_DEX_DEWPIDER,//123
    HOENN_DEX_ARAQUANID,
    HOENN_DEX_VANILLITE,//125
    HOENN_DEX_VANILLISH,
    HOENN_DEX_VANILLUXE,
    HOENN_DEX_CRYOGONAL,
    HOENN_DEX_DEINO,//129
    HOENN_DEX_ZWEILOUS,
    HOENN_DEX_HYDREIGON,
    HOENN_DEX_TYPE_NULL,//PACIFIDLOG
    HOENN_DEX_SILVALLY,
    HOENN_DEX_PANSAGE,
    HOENN_DEX_SIMISAGE,
    HOENN_DEX_PANPOUR,
    HOENN_DEX_SIMIPOUR,
    HOENN_DEX_SKRELP,//DIVE
    HOENN_DEX_DRAGALGE,
    HOENN_DEX_MAREANIE,
    HOENN_DEX_TOXAPEX,
    HOENN_DEX_PYUKUMUKU,
    ...
    HOENN_DEX_CRANIDOS,// DIVE FOSSIL
    HOENN_DEX_RAMPARDOS,
    HOENN_DEX_SHIELDON,
    HOENN_DEX_BASTIODON,
    HOENN_DEX_TIRTOUGA,
    ...
    HOENN_DEX_ARCHEN,
    HOENN_DEX_ARCHEOPS,
    HOENN_DEX_PAWNIARD,//SOOTOPOLIS
    HOENN_DEX_BISHARP,
    HOENN_DEX_KINGAMBIT,
    HOENN_DEX_JANGMO_O,//WATERFALL
    HOENN_DEX_HAKAMO_O,
    HOENN_DEX_KOMMO_O,
    HOENN_DEX_AXEW,//VICTORY ROAD
    HOENN_DEX_FRAXURE,
    HOENN_DEX_HAXORUS,
    HOENN_DEX_SNIVY,//spooky mansion
    HOENN_DEX_SERVINE,
    HOENN_DEX_SERPERIOR,
    HOENN_DEX_TEPIG,//fiery path
    HOENN_DEX_PIGNITE,
    HOENN_DEX_EMBOAR,
    HOENN_DEX_OSHAWOTT,//fish
    HOENN_DEX_DEWOTT,
    HOENN_DEX_SAMUROTT,
    HOENN_DEX_CHESPIN, //123
    HOENN_DEX_QUILLADIN,
    HOENN_DEX_CHESNAUGHT,
    HOENN_DEX_FENNEKIN,//pyre
    HOENN_DEX_BRAIXEN,
    HOENN_DEX_DELPHOX,
    HOENN_DEX_FROAKIE,//fishing
    HOENN_DEX_FROGADIER,
    HOENN_DEX_GRENINJA,
    //HOENN_DEX_ROWLET, //postgame
    //HOENN_DEX_DARTRIX,
    //HOENN_DEX_DECIDUEYE,
    //HOENN_DEX_LITTEN, //postgame
    //HOENN_DEX_TORRACAT,
    //HOENN_DEX_INCINEROAR,
    //HOENN_DEX_POPPLIO, //postgame
    //HOENN_DEX_BRIONNE,
    //HOENN_DEX_PRIMARINA,
    HOENN_DEX_TORNADUS, // LATI@S
    HOENN_DEX_THUNDURUS,// LATI@S
    HOENN_DEX_LANDORUS, // ROAMER
    HOENN_DEX_TAPU_KOKO,//120 rock
    HOENN_DEX_TAPU_LELE,//128
    HOENN_DEX_TAPU_BULU,//111 rockS
    HOENN_DEX_TAPU_FINI,//105 rock
    HOENN_DEX_PHIONE,
    HOENN_DEX_MANAPHY,//steven gift
    HOENN_DEX_DARKRAI, //lugia
    HOENN_DEX_CRESSELIA,//hooh
    HOENN_DEX_GENESECT,//deoxys
    HOENN_DEX_MARSHADOW,//mew
    HOENN_DEX_KYUREM,
    HOENN_DEX_RESHIRAM,
    HOENN_DEX_ZEKROM,//352
};

#define HOENN_DEX_COUNT (HOENN_DEX_ZEKROM + 1)
