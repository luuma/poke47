...
enum __attribute__((packed)) Species
{
    ...
    SPECIES_CUSTOMSTART	=			SPECIES_GLIMMORA_MEGA      

    SPECIES_CRUSTLE_KNOCK_FACE =                    (SPECIES_CUSTOMSTART + 1),
    SPECIES_DRIFBLIM_YAMASK     =                    (SPECIES_CUSTOMSTART + 2),
    SPECIES_DRIFBLIM_LITWICK     =                   (SPECIES_CUSTOMSTART + 3),
    SPECIES_EGG            =                         (SPECIES_CUSTOMSTART + 4),
