...
#define FLDEFF_NEW_START      FLDEFF_OW_ENCOUNTER_SPAWN_ANIM 
#define FLDEFF_SNOW_FOOTPRINTS       (FLDEFF_NEW_START +1)
#define FLDEFF_BIKE_SNOW_TRACKS (FLDEFF_NEW_START +2)
#define FLDEFF_SNOW_TRACKS_SLITHER   (FLDEFF_NEW_START +3)
#define FLDEFF_SNOW_TRACKS_SPOT      (FLDEFF_NEW_START +4)
#define FLDEFF_SNOW_TRACKS_BUG       (FLDEFF_NEW_START +5)
