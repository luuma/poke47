...
#define STATUS1_FREEZE           (1 << 12 | 1 << 13)
#define STATUS1_FREEZE_BIT1      (1 << 12)
#define STATUS1_FREEZE_BIT2      (1 << 13)
...
#define VOLATILE_DEFINITIONS(F) \
    F(VOLATILE_CONFUSION,                   confusionTurns,                (u32, B_CONFUSION_TURNS + 1), V_BATON_PASSABLE| V_PASSABLE_DEBUFF) \
    ...
    F(VOLATILE_WRAPPED_BINDING_BAND,        wrappedBindingBand,            (u32, 2)) \
...
#define STARTING_STATUS_DEFINITIONS(F) \
    ...
    F(STARTING_STATUS_INVERSE,                         inverse,                     (u32, 1)) /* inverse (Permanent) */              \
