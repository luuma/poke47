...
#define MOVES_COUNT_EXISTING MOVES_COUNT_GEN9

#define MOVE_MOOD_CRUSH (MOVES_COUNT_EXISTING + 0)
#define MOVE_ICESOAK (MOVES_COUNT_EXISTING + 1)
#define MOVE_SCREEN_BURN (MOVES_COUNT_EXISTING + 2)
#define MOVE_JUST_DESSERTS (MOVES_COUNT_EXISTING + 3)
#define MOVE_CRIT_UP_HIT (MOVES_COUNT_EXISTING + 4)
#define MOVE_BASTION_WALLS (MOVES_COUNT_EXISTING + 5)
#define MOVE_LIGHTBLOOM (MOVES_COUNT_EXISTING + 6)
#define MOVE_ENVELOP (MOVES_COUNT_EXISTING + 7)

#define MOVES_COUNT (MOVES_COUNT_EXISTING + 8)
