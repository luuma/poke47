...
#define AI_FLAG_GYM_LEADER            (AI_FLAG_BASIC_TRAINER | AI_FLAG_SMART_SWITCHING | AI_FLAG_SMART_MON_CHOICES | AI_FLAG_ASSUME_STAB)

#define AI_FLAG_SMART_TRAINER         (AI_FLAG_BASIC_TRAINER | AI_FLAG_KNOW_OPPONENT_PARTY | AI_FLAG_SMART_SWITCHING | AI_FLAG_SMART_MON_CHOICES | AI_FLAG_ASSUME_STAB | AI_FLAG_ASSUME_STATUS_MOVES | AI_FLAG_PP_STALL_PREVENTION | AI_FLAG_RANDOMIZE_SWITCHIN)

#define AI_FLAG_PSYCHIC         (AI_FLAG_BASIC_TRAINER | AI_FLAG_OMNISCIENT | AI_FLAG_SMART_SWITCHING | AI_FLAG_SMART_MON_CHOICES)

#define AI_FLAG_VERY_SMART_TRAINER         (AI_FLAG_BASIC_TRAINER | AI_FLAG_OMNISCIENT | AI_FLAG_SMART_SWITCHING | AI_FLAG_SMART_MON_CHOICES | AI_FLAG_PP_STALL_PREVENTION | AI_FLAG_RANDOMIZE_SWITCHIN | AI_FLAG_PREDICTION)
...
#define AI_FLAG_GAUNTLET              (AI_FLAG_BASIC_TRAINER | AI_FLAG_WEIGH_ABILITY_PREDICTION | AI_FLAG_ASSUME_STAB | AI_FLAG_ASSUME_STATUS_MOVES | AI_FLAG_PREDICT_MOVE)
#define AI_FLAG_GAUNTLET_RISKY             (AI_FLAG_GAUNTLET | AI_FLAG_RISKY | AI_FLAG_TRY_TO_2HKO)
#define AI_FLAG_GAUNTLET_CONSERVATIVE      (AI_FLAG_GAUNTLET | AI_FLAG_CONSERVATIVE | AI_FLAG_HP_AWARE)
#define AI_FLAG_GAUNTLET_BOSS      (AI_FLAG_BASIC_TRAINER | AI_FLAG_OMNISCIENT | AI_FLAG_PREDICT_MOVE | AI_FLAG_TRY_TO_2HKO | AI_FLAG_HP_AWARE)
