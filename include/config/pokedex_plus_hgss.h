...
#define HGSS_OVERWORLD_NOTICED_AS_SILHOUETTES	TRUE // If TRUE, the default question mark is always replaced with a silhouette of the Pokémon.
#define HGSS_UNSEEN_MONS_AS_SILHOUETTES     	TRUE // If TRUE, the default question mark is always replaced with a silhouette of the Pokémon.
