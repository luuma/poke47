...
#define TEXT_SPEED_SLOW_MODIFIER     2       // How fast the SLOW text speed option prints // rwnamed MID
#define TEXT_SPEED_MEDIUM_MODIFIER   4       //4 How fast the MID text speed option prints. //renamed FAST
#define TEXT_SPEED_FAST_MODIFIER     2       // How fast the FAST text speed option prints // renamed FASTER
