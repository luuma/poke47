...
#define OW_ROCK_SMASH_ITEMS             GEN_LATEST // In Gen4 or Gen6, breakable rocks will yield items based on those generations' mechanics Configure this in fldeff_rocksmash.c.
#define OW_ROCK_SMASH_ITEMS_MIN_ODDS    10         // Used when OW_ROCK_SMASH_ITEMS is GEN_4 to determine the minimum odds (out of 100) of an item appearing, if no specific odds are given for a rock.
...
#define OW_SHOW_ITEM_DESCRIPTIONS       OW_ITEM_DESCRIPTIONS_FIRST_TIME    // If enabled, item descriptions/images will be shown when finding items.///DISABLED FOR OVERWORLD ENCOUNTERS' SAKE
...
#define OW_BERRY_MUTATION_CHANCE       20         // Determines the % chance of a mutation.
...
#define OW_BERRY_COLORS                GEN_6_XY // DO NOT CHANGE IT REMOVES POIPOLE. If set to GEN_6_XY or GEN_6_ORAS, the Chesto, Wiki, Bluk, Cornn, Pamtre, Belue, Ganlon, Watmel, Qualot, Spelon, Kasib, Colbur, Lansat, Kee, Payapa, Roseli, Liechi, Enigma, and Maranga will use their colors from the stated game. Other values are illegal.
...
#define OW_ALTERED_TIME_RATIO           GEN_7   // In GEN_8_PLA, the time in game moves forward 60 seconds for every second in the RTC. In GEN_9, it is 20 seconds. TIME_DEBUG is 1:1, and meant for debugging purposes. This has no effect if OW_USE_FAKE_RTC is FALSE.
...
#define OW_FLAG_NO_ENCOUNTER        FLAG_UNUSED_0x022  // If this flag is set, wild encounters will be disabled.
