...
#define B_SKIP_RECHARGE             GEN_1 // HMMMMMM. In Gen1, recharging moves such as Hyper Beam skip the recharge if the target gets KO'd
...
#define B_WRAP_TURNS         9 // Max number of turns with Grip Claw AND constrictor
...
#define B_FLAG_TERA_ORB_CHARGED     FLAG_TERA     // If this flag is set, the Tera Orb is charged. It is automatically set upon healing and cleared upon Terastallizing once configured.
...
#define B_OVERWORLD_FOG                 GEN_8 // In Gen8+, overworld Fog summons Misty Terrain in battle. In Gen4 only, overworld Fog summons the unique fog weather condition in battle.
