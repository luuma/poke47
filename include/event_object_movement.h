...
void MovementType_CopyPlayerAutobattle(struct Sprite *sprite);
void MovementType_CopyPlayerAutobattleFast(struct Sprite *sprite);
void MovementType_CopyPlayerAutobattleVeryFast(struct Sprite *sprite);
void MovementType_CopyPlayerAutobattleSlow(struct Sprite *sprite);
...
u8 MovementType_WalkOnSpotCopyPlayerNormal_Step0(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_WalkOnSpotCopyPlayerNormal_Step1(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_WalkOnSpotCopyPlayerNormal_Step2(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_WalkOnSpotCopyPlayerFast_Step1(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_WalkOnSpotCopyPlayerVeryFast_Step1(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_WalkOnSpotCopyPlayerSlow_Step1(struct ObjectEvent *objectEvent, struct Sprite *sprite);
