...
const u8 gText_ChoosePokemon[] = _("Choose a POKéMON. Tap R for BOX.");
...
const u8 gText_ExpShareOn[] = _("The Exp. ALL is on.\pPoké47 uses a custom EXP formula,\nto encourage you to use many POKéMON\land explore the region thoroughly.\pTurning off the Exp. ALL is recommended.\nYou can always turn it on later.{PAUSE_UNTIL_PRESS}");
