...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_WONDERROOMENDS]                       = COMPOUND_STRING("Wonder Room wore off, and all switched base stats returned to normal!"),
    ...
    [STRINGID_TEAMGAINEDEXP]                        = COMPOUND_STRING("Team members you didn't use gained Exp. Points thanks to the Exp. ALL.\p"),
    ...
    [STRINGID_BIZARREAREACREATED]                   = COMPOUND_STRING("A bizarre area was created in which\nDefense swaps with Attack,\land Sp.Def swaps with Sp.Atk!"),
    ...
    [STRINGID_POWERCONSTRUCTTRANSFORM]              = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} transformed into its Complete Forme!"),
...
const u16 gWeatherStartsStringIds[] =
{
    ...
    [WEATHER_SNOW_HAIL]               = STRINGID_ITISHAILING,
};
