...
static const struct FormChange sCastformFormChangeTable[] =
{
    ...
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_CASTFORM_SNOWY,  WEATHER_SNOW_HAIL},
...
#if OW_FOLLOWERS_WEATHER_FORMS == TRUE
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_DEERLING_SUMMER,  WEATHER_SUNNY_CLOUDS},
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_DEERLING_SUMMER,  WEATHER_DROUGHT},
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_DEERLING_AUTUMN,  WEATHER_RAIN},
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_DEERLING_AUTUMN,  WEATHER_RAIN_THUNDERSTORM},
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_DEERLING_AUTUMN,  WEATHER_DOWNPOUR},
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_DEERLING_WINTER,  WEATHER_SNOW},
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_DEERLING_WINTER,  WEATHER_SNOW_HAIL},
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_DEERLING_SPRING,  WEATHER_NONE},
    {FORM_CHANGE_BEGIN_BATTLE,      SPECIES_DEERLING_SPRING}, // To prevent Battles from being affected.
    {FORM_CHANGE_DEPOSIT,           SPECIES_DEERLING_SPRING}, // To prevent depositing weather forms into the PC.
#endif //OW_FOLLOWERS_WEATHER_FORMS
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_DEERLING_SUMMER, B_WEATHER_SUN, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_DEERLING_AUTUMN, B_WEATHER_RAIN, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_DEERLING_WINTER, B_WEATHER_HAIL | B_WEATHER_SNOW, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_DEERLING_SPRING, ~(B_WEATHER_SUN | B_WEATHER_RAIN | B_WEATHER_HAIL | B_WEATHER_SNOW), ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_DEERLING_SPRING, B_WEATHER_NONE, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_SWITCH_OUT, SPECIES_DEERLING_SPRING},
    {FORM_CHANGE_FAINT,             SPECIES_DEERLING_SPRING},
    {FORM_CHANGE_END_BATTLE,        SPECIES_DEERLING_SPRING},
    {FORM_CHANGE_TERMINATOR},
};
...
#if OW_FOLLOWERS_WEATHER_FORMS == TRUE
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_SAWSBUCK_SUMMER,  WEATHER_SUNNY_CLOUDS},
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_SAWSBUCK_SUMMER,  WEATHER_DROUGHT},
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_SAWSBUCK_AUTUMN,  WEATHER_RAIN},
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_SAWSBUCK_AUTUMN,  WEATHER_RAIN_THUNDERSTORM},
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_SAWSBUCK_AUTUMN,  WEATHER_DOWNPOUR},
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_SAWSBUCK_WINTER,  WEATHER_SNOW},
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_SAWSBUCK_WINTER,  WEATHER_SNOW_HAIL},
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_SAWSBUCK_SPRING, WEATHER_NONE},
    {FORM_CHANGE_BEGIN_BATTLE,      SPECIES_SAWSBUCK_SPRING}, // To prevent Battles from being affected.
    {FORM_CHANGE_DEPOSIT,           SPECIES_SAWSBUCK_SPRING}, // To prevent depositing weather forms into the PC.
#endif //OW_FOLLOWERS_WEATHER_FORMS
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_SAWSBUCK_SUMMER, B_WEATHER_SUN, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_SAWSBUCK_AUTUMN, B_WEATHER_RAIN, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_SAWSBUCK_WINTER, B_WEATHER_HAIL | B_WEATHER_SNOW, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_SAWSBUCK_SPRING, ~(B_WEATHER_SUN | B_WEATHER_RAIN | B_WEATHER_HAIL | B_WEATHER_SNOW), ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_SAWSBUCK_SPRING, B_WEATHER_NONE, ABILITY_FORECAST},
    {FORM_CHANGE_BATTLE_SWITCH_OUT, SPECIES_SAWSBUCK_SPRING},
    {FORM_CHANGE_FAINT,             SPECIES_SAWSBUCK_SPRING},
    {FORM_CHANGE_END_BATTLE,        SPECIES_SAWSBUCK_SPRING},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sWishiwashiFormChangeTable[] =
{
    ...
    {FORM_CHANGE_BATTLE_HP_PERCENT_SEND_OUT, SPECIES_WISHIWASHI_MECH,   ABILITY_SCHOOLING, HP_LOWER_EQ_THAN, 50, 40},//predominates
    ...
    {FORM_CHANGE_BATTLE_HP_PERCENT_TURN_END, SPECIES_WISHIWASHI_MECH,   ABILITY_SCHOOLING, HP_LOWER_EQ_THAN, 50, 40},
...
static const struct FormChange sSilvallyFormChangeTable[] =
{
    ...
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_NORMAL,   ITEM_NONE,         ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_FIGHTING, ITEM_FIST_PLATE,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_FIGHTING, ITEM_FIGHTINIUM_Z, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_FLYING,   ITEM_SKY_PLATE,    ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_FLYING,   ITEM_FLYINIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_POISON,   ITEM_TOXIC_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_POISON,   ITEM_POISONIUM_Z,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_ROCK,     ITEM_STONE_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_ROCK,     ITEM_ROCKIUM_Z,    ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_GROUND,   ITEM_EARTH_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_GROUND,   ITEM_GROUNDIUM_Z,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_BUG,      ITEM_INSECT_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_BUG,      ITEM_BUGINIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_GHOST,    ITEM_SPOOKY_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_GHOST,    ITEM_GHOSTIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_STEEL,    ITEM_IRON_PLATE,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_STEEL,    ITEM_STEELIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_FIRE,     ITEM_FLAME_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_FIRE,     ITEM_FIRIUM_Z,     ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_WATER,    ITEM_SPLASH_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_WATER,    ITEM_WATERIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_GRASS,    ITEM_MEADOW_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_GRASS,    ITEM_GRASSIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_ELECTRIC, ITEM_ZAP_PLATE,    ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_ELECTRIC, ITEM_ELECTRIUM_Z,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_PSYCHIC,  ITEM_MIND_PLATE,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_PSYCHIC,  ITEM_PSYCHIUM_Z,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_ICE,      ITEM_ICICLE_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_ICE,      ITEM_ICIUM_Z,      ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_DRAGON,   ITEM_DRACO_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_DRAGON,   ITEM_DRAGONIUM_Z,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_DARK,     ITEM_DREAD_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_DARK,     ITEM_DARKINIUM_Z,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_FAIRY,    ITEM_PIXIE_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_FAIRY,    ITEM_FAIRIUM_Z,    ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_FIGHTING, ITEM_BLACK_BELT,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_FLYING,   ITEM_SHARP_BEAK,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_POISON,   ITEM_POISON_BARB,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_ROCK,     ITEM_HARD_STONE,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_GROUND,   ITEM_SOFT_SAND,    ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_BUG,      ITEM_SILVER_POWDER,ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_GHOST,    ITEM_SPELL_TAG,    ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_STEEL,    ITEM_METAL_COAT,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_FIRE,     ITEM_CHARCOAL,     ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_WATER,    ITEM_MYSTIC_WATER, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_GRASS,    ITEM_MIRACLE_SEED, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_ELECTRIC, ITEM_MAGNET,       ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_PSYCHIC,  ITEM_TWISTEDSPOON, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_ICE,      ITEM_NEVERMELTICE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_DRAGON,   ITEM_DRAGON_FANG,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_DARK,     ITEM_BLACK_GLASSES,ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_SILVALLY_FAIRY,    ITEM_FAIRY_FEATHER,ABILITY_MULTITYPE},
    {FORM_CHANGE_TERMINATOR},
};
...
{
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_DRIFBLIM_YAMASK, ABILITY_GULP_MISSILE, HP_HIGHER_THAN,   50, MOVE_STOCKPILE},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_DRIFBLIM_LITWICK, ABILITY_GULP_MISSILE, HP_LOWER_EQ_THAN, 50, MOVE_STOCKPILE},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_DRIFBLIM_YAMASK, ABILITY_GULP_MISSILE, HP_HIGHER_THAN,   50, MOVE_SHADOW_FORCE},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_DRIFBLIM_LITWICK, ABILITY_GULP_MISSILE, HP_LOWER_EQ_THAN, 50, MOVE_SHADOW_FORCE},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_DRIFBLIM_YAMASK, ABILITY_GULP_MISSILE, HP_HIGHER_THAN,   50, MOVE_PHANTOM_FORCE},
    {FORM_CHANGE_BATTLE_HP_PERCENT_DURING_MOVE, SPECIES_DRIFBLIM_LITWICK, ABILITY_GULP_MISSILE, HP_LOWER_EQ_THAN, 50, MOVE_PHANTOM_FORCE},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sCrustleFormChangeTable[] =
{
    ...
    {FORM_CHANGE_BATTLE_HIT_BY_CONFUSION_SELF_DMG, SPECIES_CRUSTLE_KNOCK_FACE, ABILITY_ICE_FACE},
    {FORM_CHANGE_BATTLE_HIT_BY_MOVE_CATEGORY,      SPECIES_CRUSTLE_KNOCK_FACE, ABILITY_ICE_FACE, DAMAGE_CATEGORY_PHYSICAL},
