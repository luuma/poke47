...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_MARACTUS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities  = {ABILITY_IRON_BARBS, ABILITY_SAND_FORCE, ABILITY_WELL_BAKED_BODY},// sturdy spikyshield endeavor tho.
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_RUFFLET] = // +10atk +10def +10HP
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities  = {ABILITY_HUSTLE, ABILITY_SHEER_FORCE, ABILITY_DEFIANT},
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_BRAVIARY] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities  = {ABILITY_QUICK_DRAW, ABILITY_SHEER_FORCE, ABILITY_DEFIANT},
        .bodyColor = BODY_COLOR_RED,
