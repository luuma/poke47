...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_MARACTUS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities  = {ABILITY_IRON_BARBS, ABILITY_SAND_FORCE, ABILITY_WELL_BAKED_BODY},
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SIGILYPH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_MAGIC_GUARD, ABILITY_WONDER_SKIN, ABILITY_PLANE_SHIFT },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_ESCAVALIER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities  = {ABILITY_ANGER_SHELL, ABILITY_LONG_REACH, ABILITY_SHELL_ARMOR},
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_STUNFISK] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_LIMBER, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_BROWN,
