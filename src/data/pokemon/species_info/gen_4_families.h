...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_PACHIRISU] =
    {
        ...
        .abilities = {ABILITY_PICKUP, ABILITY_GALVANIZE, ABILITY_VOLT_ABSORB},
    ...
    [SPECIES_SHELLOS_WEST] =
    {
        ...
        .autobattleMovementType = MOVEMENT_TYPE_COPY_PLAYER_AUTOBATTLE,
        .overworldEncounterBehavior = OWE_APPROACH_PLAYER_SLOW, // OWE_CHASE_PLAYER_SLOW OWE_IGNORE_PLAYER OWE_FLEE_PLAYER_NORMAL OWE_WATCH_PLAYER_NORMAL OWE_DESPAWN_ON_NOTICE OWE_APPROACH_PLAYER_SLOW
...
#define ROTOM_FAMILY_TYPES { TYPE_ELECTRIC, TYPE_GHOST }
    ...
    [SPECIES_SHAYMIN_LAND] =
    {
        ...
        .eggCycles = 120,
        .friendship = 100,
        .growthRate = GROWTH_MEDIUM_SLOW,// oh shit!!!! that's actually spooky!!! fuck!
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_GRASS_PELT, ABILITY_NONE, ABILITY_NATURAL_CURE },
        .bodyColor = BODY_COLOR_GREEN,
        ...
        .teachableLearnset = sShayminTeachableLearnset,
    ...
    [SPECIES_SHAYMIN_SKY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_NONE, ABILITY_WIND_RIDER},
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
        .speciesName = _("Shaymin"),
