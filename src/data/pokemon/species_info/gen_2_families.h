...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_MEGANIUM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_MEGA_SOL, ABILITY_GRASSY_SURGE, ABILITY_MEGA_SOL },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_CYNDAQUIL] =
    {
        ...
        .abilities = { ABILITY_BLAZE, ABILITY_INCENDIARY, ABILITY_FLASH_FIRE },
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_RUN_AWAY, ABILITY_SIMPLE, ABILITY_FRISK },
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        .abilities = { ABILITY_EARLY_BIRD, ABILITY_STAKEOUT, ABILITY_TINTED_LENS },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_ARIADOS] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_UNNERVE, ABILITY_SNIPER },
        .bodyColor = BODY_COLOR_RED,
...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_NATU] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_FOREWARN, ABILITY_MAGIC_BOUNCE, ABILITY_SYNCHRONIZE },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Natu"),
        .cryId = CRY_NATU,
    ...
    [SPECIES_XATU] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_MAGIC_BOUNCE, ABILITY_SYNCHRONIZE },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Xatu"),
        .cryId = CRY_XATU,
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .abilities = { ABILITY_STATIC_TOUCH, ABILITY_FUR_COAT, ABILITY_PLUS },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_AMPHAROS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_STATIC_TOUCH, ABILITY_DAZZLING, ABILITY_PLUS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_HOPPIP] =
    {
        ...
        .abilities = { ABILITY_PRANKSTER, ABILITY_SYMBIOSIS, ABILITY_LEAF_GUARD},
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_JUMPLUFF] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_GRASS),
        .abilities = { ABILITY_PRANKSTER, ABILITY_HUSTLE, ABILITY_FLUFFY},// GRAVITY BOYYY
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_AIPOM] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_RECEIVER, ABILITY_PICKUP, ABILITY_SKILL_LINK },
    ...
    [SPECIES_SUNKERN] =
    {
        ...
        .abilities = { ABILITY_MOODY, ABILITY_SOLAR_POWER, ABILITY_EARLY_BIRD },
    #else
    ...
    [SPECIES_HONCHKROW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_SUPREME_OVERLORD, ABILITY_SUPER_LUCK, ABILITY_MOXIE },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_MISDREAVUS] =
    {
        ...
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_SHADOW_SHIELD },
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    {                                                                                                   \
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                                               \
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),                                      \
        .abilities = { ABILITY_LEVITATE, ABILITY_TELEPATHY, ABILITY_MOVE_RELEARNER },                                  \
        .bodyColor = BODY_COLOR_BLACK,                                                                  \
        .noFlip = _noFlip,                                                                              \
        .speciesName = _("Unown"),                                                                      \
        .cryId = CRY_UNOWN,                                                                             \
    ...
    [SPECIES_PINECO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_STURDY, ABILITY_SHIELD_DUST, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_DUNSPARCE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_AERILATE, ABILITY_RATTLED },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_GLIGAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_GUTS, ABILITY_SAND_RUSH, ABILITY_HYPER_CUTTER},
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_GLISCOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_POISON_HEAL, ABILITY_SAND_FORCE, ABILITY_HYPER_CUTTER },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_GRANBULL] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_FAIRY),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_INTIMIDATE, ABILITY_PIXILATE, ABILITY_QUICK_FEET },
    #else
    ...
    [SPECIES_QWILFISH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_TECHNICIAN, ABILITY_INTIMIDATE },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_SHUCKLE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_PRANKSTER, ABILITY_GLUTTONY, ABILITY_CONTRARY },
    #else
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PRESSURE, ABILITY_TOUGH_CLAWS, ABILITY_MOXIE },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_URSARING] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_GUTS, ABILITY_MOLD_BREAKER, ABILITY_HONEY_GATHER },
    #else
    ...
    [SPECIES_SLUGMA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_MAGMA_ARMOR, ABILITY_LIQUID_OOZE, ABILITY_WEAK_ARMOR },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_SWINUB] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_FUR_COAT, ABILITY_OBLIVIOUS, ABILITY_THICK_FAT },
    #else
    ...
    [SPECIES_PILOSWINE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_FUR_COAT, ABILITY_OBLIVIOUS, ABILITY_STORM_DRAIN },
    #else
        .abilities = { ABILITY_OBLIVIOUS, ABILITY_NONE, ABILITY_THICK_FAT },
    #endif
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_CORSOLA] =
    {
        ...
        .abilities = { ABILITY_ARMOR_TUNING, ABILITY_NATURAL_CURE, ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_CURSOLA] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_3),
        .abilities = { ABILITY_WEAK_ARMOR, ABILITY_ARMOR_TUNING, ABILITY_PERISH_BODY },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
    ...
    [SPECIES_MANTINE] =
    {
        ...
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_WATER_ABSORB, ABILITY_VOLT_ABSORB },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_HOUNDOOM] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_QUICK_FEET, ABILITY_FLASH_FIRE, ABILITY_SOLAR_POWER },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STURDY, ABILITY_HEAVY_METAL, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_WYRDEER] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_TRICKLAND, ABILITY_SAP_SIPPER },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_MILTANK] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_THICK_FAT, ABILITY_SCRAPPY, ABILITY_REGENERATOR },
    #else
    ...
    [SPECIES_SUICUNE] =
    {
        .baseHP        = 100,
        .baseAttack    = 75,
        .baseDefense   = 115,//was +3
        .baseSpeed     = 85,//was +5??
        .baseSpAttack  = 90,// WAS+25????
        .baseSpDefense = 115,//was+3
        .types = MON_TYPES(TYPE_WATER),
        .catchRate = 3,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 290,
    ...
    [SPECIES_PUPITAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_SHED_SKIN, ABILITY_EARTH_EATER, ABILITY_BATTLE_ARMOR },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_TYRANITAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_SAND_STREAM, ABILITY_DARK_AURA, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_GREEN,
