...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_PROTECT] =
    {
        ...
        .copycatBanned = TRUE,
        .assistBanned = TRUE,
        .gravityBanned = TRUE,//protectgrav
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_AVOID_STARTLE_ONCE : CONTEST_EFFECT_AVOID_STARTLE,
        .contestCategory = CONTEST_CATEGORY_CUTE,
        .contestComboStarterId = 0,
    ...
    [MOVE_RAIN_DANCE] =
    {
        ...
        .ignoresProtect = TRUE,
        .mirrorMoveBanned = TRUE,
        .danceMove = TRUE,// added.... i often forget this sin't true, and it works with spandex flares well.
    ...
    [MOVE_ROCK_BLAST] =
    {
        ...
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .multiHit = TRUE,
        .pulseMove = B_UPDATED_MOVE_FLAGS >= GEN_6,
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_QUALITY_DEPENDS_ON_TIMING : CONTEST_EFFECT_BETTER_IF_SAME_TYPE,
        .contestCategory = CONTEST_CATEGORY_TOUGH,
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
    ...
    [MOVE_FISHIOUS_REND] =
    {
        .name = COMPOUND_STRING("Vicious Rend"),
        .description = COMPOUND_STRING(
            "Double power if the user\n"
            "moves before the target."),
        .effect = EFFECT_BOLT_BEAK,
    ...
    [MOVE_MOOD_CRUSH] =// KEEPER
    {
        ...
        .argument = { .overwriteAbility = ABILITY_DEFEATIST },
        .contestEffect = CONTEST_EFFECT_STARTLE_MONS_SAME_TYPE_APPEAL,
        .contestCategory = CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .battleAnimScript = gBattleAnimMove_BaddyBad,
    ...
    [MOVE_SCREEN_BURN] =// Just about a KEEPER
    {
        ...
        .description = COMPOUND_STRING(
            "Sacrifices HP to set\n"
            "Reflect and Light Screen."),
        .effect = EFFECT_SCREEN_BURN,
        .power = 0,
        .type = TYPE_ELECTRIC,
        .accuracy = 0,
        .pp = 5,
    ...
    [MOVE_BASTION_WALLS] = // KEEPER. absolute GEM 
    {
        ...
        .description = COMPOUND_STRING(
            "Ups Defense. Artillery fires\n"
            "whenever the user is hit."),    //ANIM TODO
    ...
    [MOVE_FORBIDDEN_FANG] =// well it was easy to implement.
    {
        ...
        .description = COMPOUND_STRING(
            "The target is rended for\n"
            "half their maximum HP."),
        .effect = EFFECT_FORBIDDEN_FANG,
        .power = 0,
        .type = TYPE_DARK,
        .accuracy = 100,
        .pp = 5,
    ...
    [MOVE_BRIGHTEST_DAWN] =// Keeper
    {
        ...
        .description = COMPOUND_STRING(
            "The user faints to let\n"
            "its recipient Dynamax."),
        .effect = EFFECT_BRIGHTEST_DAWN,
        .power = 0,
        .type = TYPE_DRAGON,
        .accuracy = 0,
        .pp = 5,
