        ...
        if (!gPaletteFade.active)
        {
            if (gInitialSummaryScreenCallback != NULL)
            {
                ...
                case RELEARN_MODE_BATTLING_PSS_PAGE_BATTLE_MOVES:
                    ShowPokemonSummaryScreen(SUMMARY_MODE_BATTLING_RELEARNER_BATTLE, gPlayerParty, sMoveRelearnerStruct->partyMon, gPlayerPartyCount - 1, gInitialSummaryScreenCallback);///////////////oranguru sigh..
                    break;
                default:
