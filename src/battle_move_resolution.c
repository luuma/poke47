...
{
    if ((ctx.abilities[ctx.battlerAtk] == ABILITY_PARENTAL_BOND || (ctx.abilities[ctx.battlerAtk] == ABILITY_DOUBLE_WALLOP && gBattleMons[gBattlerTarget].hp <= gBattleMons[gBattlerTarget].maxHP * 3 / 4) )
