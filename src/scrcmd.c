...
// altar 3 SATK kyo . should maybe be def. 6-8
    {
        ...
        .level = 25,// was like blizzard lv30 lv26 no ai. Generally an ok fight. Some cool shit with frostbite drainpunch.
        .dynlevel = 10,
    ...
    },
    {
        ...
        .level = 24,// was like icy wind lv27 lv25 no ai. Always a solid fight. fire is swing tastic though so I don't know I like it.
        .dynlevel = 10,
        .item = ITEM_LEFTOVERS,
...
/// altar 6, boss, 15-20
    ...
    },
    {
        ...
        .moves = {MOVE_ORIGIN_PULSE, MOVE_ICY_WIND, MOVE_DAZZLING_GLEAM, MOVE_WAVE_CRASH},
        .level = 55,
        .dynlevel = 10,
    ...
    },
    {
        ...
        .moves = {MOVE_GLACIATE, MOVE_HAZE, MOVE_BREAKING_SWIPE, MOVE_CALM_MIND},
        .level = 55,
        .item = ITEM_CLEAR_AMULET,
    },
    {
    ...
    },
    {
        ...
        .moves = {MOVE_PRECIPICE_BLADES, MOVE_ROCK_SLIDE, MOVE_EARTH_POWER, MOVE_ERUPTION},
        .level = 55,
        .dynlevel = 10,
        .item = ITEM_COVERT_CLOAK,
    },
    {
        ...
        .moves = {MOVE_COUNTER, MOVE_REVERSAL, MOVE_AURA_SPHERE, MOVE_CRIT_UP_HIT},
        .level = 60,
        .dynlevel = 10,
        .item = ITEM_SKY_PLATE,
    },
...
void ScrCmd_SetGauntletBossBattle(struct ScriptContext *ctx)
{
    ...
    enum Species species2 = sGauntletBossList[bossIdx].speciesBuddy;
    if (species2 != SPECIES_NONE)
    {
        u32 personality = GetMonPersonality(species2,
        GetSynchronizedGender(STATIC_WILDMON_ORIGIN, species),
        GetSynchronizedNature(STATIC_WILDMON_ORIGIN, species),
        RANDOM_UNOWN_LETTER);
        CreateMonWithIVs(&gParties[B_TRAINER_OPPONENT_A][1], species2, sGauntletBossList[bossIdx].levelBuddy, personality, OTID_STRUCT_PLAYER_ID, USE_RANDOM_IVS);
