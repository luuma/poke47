...
{
    u16 monData;
    CreateRandomMon(&gParties[B_TRAINER_0][0], SPECIES_LILLIPUP, 7);
    monData = TRUE;
...
static const u8 *const sScrollableMultichoiceOptions[][MAX_SCROLL_MULTI_LENGTH] =
{
    ...
    {
        COMPOUND_STRING("KISS POSTER{CLEAR_TO 0x64}2BP"),
        COMPOUND_STRING("KISS CUSHION{CLEAR_TO 0x64}4BP"),
        COMPOUND_STRING("SMOOCHUM DOLL{CLEAR_TO 0x64}4BP"),
        COMPOUND_STRING("TOGEPI DOLL{CLEAR_TO 0x64}6BP"),
        COMPOUND_STRING("MEOWTH DOLL{CLEAR_TO 0x64}6BP"),
        COMPOUND_STRING("CLEFAIRY DOLL{CLEAR_TO 0x64}6BP"),
        COMPOUND_STRING("DITTO DOLL{CLEAR_TO 0x64}6BP"),
    ...
    {
        COMPOUND_STRING("LAPRAS DOLL{CLEAR_TO 0x5E}16BP"),
        COMPOUND_STRING("SNORLAX DOLL{CLEAR_TO 0x5E}16BP"),
        COMPOUND_STRING("VENUSAUR DOLL{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("CHARIZARD DOLL{CLEAR_TO 0x5E}32BP"),
        COMPOUND_STRING("BLASTOISE DOLL{CLEAR_TO 0x5E}32BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_VITAMIN_VENDOR] =
    {
        COMPOUND_STRING("POWER WEIGHT{CLEAR_TO 0x64}1BP"),
        COMPOUND_STRING("POWER BRACER{CLEAR_TO 0x64}1BP"),
        COMPOUND_STRING("POWER BELT{CLEAR_TO 0x64}1BP"),
        ...
        COMPOUND_STRING("LUCKY EGG{CLEAR_TO 0x64}4BP"),
        gText_Exit
    },
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_HOLD_ITEM_VENDOR] =
    {
        COMPOUND_STRING("LEFTOVERS{CLEAR_TO 0x64}6BP"),
        COMPOUND_STRING("SILVER POWDER{CLEAR_TO 0x64}6BP"),
        COMPOUND_STRING("SPANDEX FLARES{CLEAR_TO 0x64}6BP"),
        COMPOUND_STRING("THROAT SPRAY{CLEAR_TO 0x64}6BP"),
        COMPOUND_STRING("BRIGHT POWDER{CLEAR_TO 0x64}8BP"),
        COMPOUND_STRING("CHOICE BAND{CLEAR_TO 0x64}8BP"),
        COMPOUND_STRING("CHOICE SPECS{CLEAR_TO 0x64}8BP"),
        COMPOUND_STRING("ASSAULT VEST{CLEAR_TO 0x64}8BP"),
        COMPOUND_STRING("KING'S ROCK{CLEAR_TO 0x64}8BP"),
        gText_Exit
    },
